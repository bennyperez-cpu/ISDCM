<%-- 
    Document   : listadoVid
    Created on : 17-abr-2022, 10:54:19
    Author     : alumne
--%>
...
<html>
    ...
    <body>
        <div class="wrapper">
            <!-- Sidebar -->
            <nav id="sidebar">
                <div class="sidebar-header" method="POST">
                ...
                <ul class='list-unstyled CTAs  text-center'>
                    <li>
                        <a href="listadoVid.jsp?c=1">Salir</a>
                        <%--<button name="action" value="salir" type="submit" class="button"><i class="fa-solid fa-magnifying-glass"></i> Salir</button>--%>
                    </li> 
                </ul>
            </nav>
        ...
        <%            
            ...
            /*if (ses.getAttribute("userName")!=null){
                out.print("Bienvenid@" + ses.getAttribute("userName"));
            } else {
