<%-- 
    ...
    Created on : 17-abr-2022, 16:06:12
    Author     : alumne
--%>
        ...
        <div class="container col-lg-3">
            <form action= "${pageContext.request.contextPath}/servletRegistroVid" method ="post">                
                <div class="form-group all ">
                    ...
                    <input name="formato" type="text" class="form-control" required id="duration" placeholder="MOV" pattern=".{0,10}" title="No más de 5 caractéres">
