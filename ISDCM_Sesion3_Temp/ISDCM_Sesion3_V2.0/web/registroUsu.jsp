<%-- 
    ...
    Created on : 17-abr-2022, 10:53:46
    Author     : alumne
--%>
        ...
        <div class="container col-lg-3">
            ...
            <form action= "servletUsuarios" method ="post" >
                ...
                <div class="form-group text-center">
                    ...
                    <button type="button" onclick="location.href='registroUsu.jsp?c=1'" class="button" style="float: right " ><i class="fa-solid fa-right-from-bracket"></i> Salir</button>
                    <br>
